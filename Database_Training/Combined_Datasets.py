...
class Combined_Datasets(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if isinstance(surface_maps, torch.Tensor):
            surface_maps_stack = surface_maps
        else:
            raise ValueError(f'Expected to get Surface Maps to be a tensor but got {type(surface_maps)}')
